 ...
 */
export async function indexAllSources(options = {}) {
    const { sources: requestedSources, concurrency = 1, noSummaries = false, maxConversations, } = options;
    console.log('Initializing database...');
    const db = initDatabase();
    console.log('Loading embedding model...');
    await initEmbeddings();
    ...
    const defaultSources = ['gemini', 'pi', 'opencode'];
